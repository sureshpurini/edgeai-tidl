...
from east_utils_1 import resize_img, load_pil, get_boxes, adjust_ratio, plot_boxes
...
def run_model(model, mIdx):
    ...
    if config['model_type'] == 'classification':
        ...
        base_path = '../../../ICDAR/img_'
        test_images = ['../../../ICDAR/img_11.jpg']
...
models = ['east-mobilenet-simplified-no-norm']
if(SOC == "am69a"):

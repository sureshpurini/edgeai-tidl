...
models_configs = {
    ...
    'yolov5s6_640_ti_lite_37p4_56p0' : {
        'model_path' : os.path.join(models_base_path, 'yolov5s6_640_ti_lite_37p4_56p0.onnx'),
        'mean': [0, 0, 0],
        ...
        'od_type' : 'YoloV5',
        'framework' : '',
        'meta_layers_names_list' : os.path.join(models_base_path, 'yolov5s6_640_ti_lite_metaarch.prototxt'),
        'session_name' : 'onnxrt' ,
        'meta_arch_type' : 6
    },
